...
def getsptopcolor(filename,listofcoords,tree,mapped_colors):
    ...
    #mapped_colors = [(255, 255, 255),(240,240,240),(204,204,204),(153,204,255), (102,255,102)
    #(255,204,102),(255,255,204),(204,255,204),(255,153,51),(225,225,225)] # list of web-save colors
    ...
    classb = [(204,204,204),(240,240,240)] #buildings
    classc = [(153,204,255)] # water
    classd = [(102,255,102),(204,255,204),(225,225,225)] #other 
    classes = {"A":classa, "B":classb, "C":classc,"D":classd}
...
def getroadmapimgs(dataset_folder,image_dict,tree,mapped_colors):
    ...
    for img in image_dict:
        ...
        for fname in image_dict.keys():
            rfname = fname.replace("satellite","roadmap")
            #image = img_as_float(io.imread(filename))
            print("SFilename: "+fname)
            print("RFilemame: "+rfname)
            image_labels[fname] = dict()
            for spxl in image_dict[fname].keys():
                image_labels[fname][spxl] = getsptopcolor(rfname, image_dict[fname][spxl], tree, mapped_colors)
...
def get_training_labels(folder):
    ...
    mapped_colors = [(255,255,255),(240,240,240),(204,204,204),(153,204,255),(102,255,102),(255,204,102),(255,255,204),(204,255,204),(255,153,51),(225,225,225)] 
